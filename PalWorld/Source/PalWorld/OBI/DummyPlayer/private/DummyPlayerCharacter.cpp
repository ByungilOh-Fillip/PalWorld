...
void ADummyPlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ADummyPlayerCharacter::Look);
...
void ADummyPlayerCharacter::DoMove(float Right, float Forward)
{
...
void ADummyPlayerCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ADummyPlayerCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ADummyPlayerCharacter::DoJumpEnd()
{
